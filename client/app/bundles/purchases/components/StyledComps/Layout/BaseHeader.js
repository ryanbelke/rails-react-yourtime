...
const BaseHeader = styled.div`
  ...
  ${(props) => props.primary ? `
    left: 0;
  top: 0;
  background: -moz-linear-gradient(top, #2d6efd 0%, #2d54bf 100%);
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #2d6efd), color-stop(100%, #2d54bf)); 
  background: webkit-linear-gradient(top, #2d6efd 0%, #2d54bf 100%);
  background: -ms-linear-gradient(top, #2d6efd 0%, #2d54bf 100%);
